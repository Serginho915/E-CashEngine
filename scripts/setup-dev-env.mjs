...
function ensureEnv({ file, example, defaults = {}, generated = {}, inherited = {} }) {
  ...
  fs.writeFileSync(target, render(values, order), { mode: 0o600 });
...
ensureEnv({
  ...
  example: ".env.example",
  defaults: {
    LOCAL_SUPERADMIN_EMAIL: "admin@ecashengine.local",
...
ensureEnv({
  ...
  defaults: {
    ...
    PORT: "4000",
    DATABASE_URL: "postgres://ecashengine:ecashengine@localhost:5432/ecashengine",
